...
const VerifyEmail = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 overflow-hidden bg-[#060A12] text-[#E7EDF7]">
      {/* faint structural grid — matches Home / Login / ResetPassword */}
      <div
      ...
      {/* single cool glow, one place, one accent — matches Home / Login / ResetPassword */}
        ...
        <div className="relative bg-slate-800/90 backdrop-blur-xl p-8 sm:p-10 rounded-3xl border border-slate-700/50 shadow-2xl">
          <div className="text-center mb-8">
            <div className="relative inline-block mb-4">
              <div className="absolute inset-0 bg-gradient-to-r from-blue-600 to-cyan-500 rounded-full blur-lg opacity-50 animate-ping"></div>
            ...
            <div className="text-center">
              {canResend ? (
                ...
                <p className="text-sm text-slate-400">
                  Resend code in{" "}
                  <span className="text-blue-400 font-medium">{timeLeft}s</span>
                </p>
              )}
            </div>
